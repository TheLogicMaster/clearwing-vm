...
class InetAddress implements java.io.Serializable {
     ...
     */
    static {
        String str = null;// java.security.AccessController.doPrivileged(new GetPropertyAction("java.net.preferIPv6Addresses"));
        if (str == null) {
...
//                }
    ...
    private static final NavigableSet<CachedAddresses> expirySet = null;// new ConcurrentSkipListSet<>();
...
//                    }
    ...
    private static NameService createNameService() {
        ...
        String hostsFileName = null;// GetPropertyAction.privilegedGetProperty("jdk.net.hosts.file");
