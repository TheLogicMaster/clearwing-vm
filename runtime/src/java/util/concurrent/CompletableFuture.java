...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    final synchronized boolean internalComplete(Object r) { // CAS from null to r
        if (result != null)
            return false;
        result = r;
        return true;
    ...
    final synchronized boolean tryPushStack(Completion c) {
        Completion h = stack;
        c.next = h; // CAS piggyback
        if (stack != h)
            return false;
        stack = c;
        return true;
    ...
    final synchronized boolean completeNull() {
        if (result != null)
            return false;
        result = NIL;
        return true;
    ...
    final synchronized boolean completeValue(T t) {
        if (result != null)
            return false;
        result = (t == null) ? NIL : t;
        return true;
    ...
    final synchronized boolean completeThrowable(Throwable x) {
        if (result != null)
            return false;
        result = encodeThrowable(x);
        return true;
    }
     ...
     */
    final synchronized boolean completeThrowable(Throwable x, Object r) {
        if (result != null)
            return false;
        result = encodeThrowable(x, r);
        return true;
    }
     ...
     */
    final synchronized boolean completeRelay(Object r) {
        if (result != null)
            return false;
        result = encodeRelay(r);
        return true;
    }
     ...
     */
    final synchronized void postComplete() {
        /*
    ...
    final synchronized void cleanStack() {
        Completion p = stack;
     ...
     */
    final synchronized void unipush(Completion c) {
        if (c != null) {
     ...
     */
    final synchronized void orpush(CompletableFuture<?> b, BiCompletion<?,?,?> c) {
        if (c != null) {
            while (!tryPushStack(c)) {
                if (result != null) {
                    c.next = null;
